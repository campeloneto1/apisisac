...
export class MateriaisConsumoEntradasItensService {
    ...
    async index(): Promise<MateriaisConsumoEntradasItensInterface> {
      ...
      async create(objectreq: MaterialConsumoEntradaItemInterface, idUser: User) {
        var object:MaterialConsumoEntradaItemInterface = this.materialConsumoEntradaItemRepository.create({...objectreq, created_by: idUser}) 
      ...
      async update(id:number, object: MaterialConsumoEntradaItemInterface, idUser: User) {
        var data: MaterialConsumoEntradaItemInterface = await this.materialConsumoEntradaItemRepository.findOneBy({id: id});
        data = {...object}
      ...
      async remove(id: number, idUser: User) {
        var object:MaterialConsumoEntradaItemInterface = await this.materialConsumoEntradaItemRepository.findOne({where: {id: id}});
      ...
      async whereMatCon(id:number): Promise<MateriaisConsumoEntradasItensInterface>{
        return await this.materialConsumoEntradaItemRepository.find({
          where: {
