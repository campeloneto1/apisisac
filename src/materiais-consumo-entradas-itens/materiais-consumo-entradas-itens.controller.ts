...
export class MateriaisConsumoEntradasItensController {
    constructor(private materiasConsumoEntradasItensService: MateriaisConsumoEntradasItensService){}
    ...
    async create(@Body() object: MaterialConsumoEntradaItem, @Request() req) {
        return await this.materiasConsumoEntradasItensService.create(object, req.user);
    }

    @Put(':id')
    async update(@Param('id') id: number, @Body() object: MaterialConsumoEntradaItem, @Request() req) {
        return await this.materiasConsumoEntradasItensService.update(id, object, req.user);
    }
