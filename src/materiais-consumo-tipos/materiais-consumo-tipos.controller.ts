...
export class MateriaisConsumoTiposController {
    constructor(private materialConsumoTiposService: MateriaisConsumoTiposService){}
    ...
    @Put(':id')
    async update(@Param('id') id: number, @Body() object: MaterialConsumoTipo, @Request() req) {
