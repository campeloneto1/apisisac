...
export class MateriaisConsumoSaidasItensController {
    constructor(private materiasConsumoSaidasItensService: MateriaisConsumoSaidasItensService){}
    ...
    async create(@Body() object: MaterialConsumoSaidaItem, @Request() req) {
        return await this.materiasConsumoSaidasItensService.create(object, req.user);
    }

    @Put(':id')
    async update(@Param('id') id: number, @Body() object: MaterialConsumoSaidaItem, @Request() req) {
        return await this.materiasConsumoSaidasItensService.update(id, object, req.user);
    }
