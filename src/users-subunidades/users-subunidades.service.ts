...
export class UsersSubunidadesService {
    constructor(
      ...
      async create(object: UserSubunidadeInterface, idUser: User) {
        var object:UserSubunidadeInterface = this.usersSubunidadesRepository.create({...object, created_by: idUser}) 
      ...
      async update(id:number, object: UserSubunidadeInterface, idUser: User) {
        var data: UserSubunidadeInterface = await this.usersSubunidadesRepository.findOneBy({id: id});
        data = {...object}
