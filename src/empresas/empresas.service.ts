...
export class EmpresasService {
  ...
  async create(object: EmpresaInterface, idUser: User) {
    var object: EmpresaInterface = this.empresaRepository.create({
      ...object,
      created_by: idUser,
    });
  ...
  async update(id: number, object: EmpresaInterface, idUser: User) {
    var data: EmpresaInterface = await this.empresaRepository.findOneBy({
      id: id,
    });
  ...
  async remove(id: number, idUser: User) {
    var data = await this.empresaRepository.findOne({
      where: {
        id: id,
      },
    });
