...
import {
  ArmamentoTipo as ArmamentoTipoInterface,
  ArmamentosTipos as ArmamentosTiposInterface,
} from './armamento-tipo.interface';
...
export class ArmamentosTiposService {
  ...
  async create(object: ArmamentoTipoInterface, idUser: User) {
    var object: ArmamentoTipoInterface = this.armamentoTipoRepository.create({
      ...object,
      created_by: idUser,
    });
  ...
  async update(id: number, object: ArmamentoTipoInterface, idUser: User) {
    var data: ArmamentoTipoInterface =
