...
import {
  ArmamentoTamanho as ArmamentoTamanhoInterface,
  ArmamentosTamanhos as ArmamentosTamanhosInterface,
...
export class ArmamentosTamanhosService {
  ...
  async create(object: ArmamentoTamanhoInterface, idUser: User) {
    var object: ArmamentoTamanhoInterface = this.armamentoTipoRepository.create(
      { ...object, created_by: idUser },
    );
  ...
  async update(id: number, object: ArmamentoTamanhoInterface, idUser: User) {
    var data: ArmamentoTamanhoInterface =
      await this.armamentoTipoRepository.findOneBy({ id: id });
    data = { ...object };
    await this.armamentoTipoRepository.update(
      { id: id },
  ...
  async remove(id: number, idUser: User) {
    var data = await this.armamentoTipoRepository.findOne({
      where: {
        id: id,
      },
    });
