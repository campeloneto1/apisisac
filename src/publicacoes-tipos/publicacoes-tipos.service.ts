...
import {
  PublicacaoTipo as PublicacaoTipoInterface,
  PublicacoesTipos as PublicacoesTiposInterface,
} from './publicacao-tipo.interface';
...
export class PublicacoesTiposService {
  ...
  async create(object: PublicacaoTipoInterface, idUser: User) {
    var object: PublicacaoTipoInterface = this.sexoRepository.create({
      ...object,
      created_by: idUser,
    });
  ...
  async update(id: number, object: PublicacaoTipoInterface, idUser: User) {
    var data: PublicacaoTipoInterface = await this.sexoRepository.findOneBy({
      id: id,
    });
    data = { ...object };
