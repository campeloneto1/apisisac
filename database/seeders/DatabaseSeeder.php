...
class DatabaseSeeder extends Seeder
{
     ...
     * Seed the application's database.
     ...
     UPDATE `perfis` SET `administrador`= 1,`gestor`= 1,`oficial_dia`= 1,`afastamentos`= 1,`afastamentos_cad`= 1,`afastamentos_edt`= 1,`afastamentos_del`= 1,`documentos`= 1,`documentos_cad`= 1,`documentos_edt`= 1,`documentos_del`= 1,`escalas`= 1,`escalas_cad`= 1,`escalas_edt`= 1,`escalas_del`= 1,`irsos`= 1,`irsos_cad`= 1,`irsos_edt`= 1,`irsos_del`= 1,`publicacoes`= 1,`publicacoes_cad`= 1,`publicacoes_edt`= 1,`publicacoes_del`= 1,`usuarios`= 1,`usuarios_cad`= 1,`usuarios_edt`= 1,`usuarios_del`= 1 WHERE id = 1
     *
     * @return void
     */
    public function run()
