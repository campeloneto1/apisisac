    ...
    public function gastomensal($id)
    {
        ...
        if($user->perfil->administrador){
            ...
            return DB::select("SELECT 
                    ...
                    SUM(if(users.graduacao_id = 1, irsos_financeiros.valor_irso_sd * irsos.duracao, 0)) AS 'SD',
                    SUM(if(users.graduacao_id = 2, 1, 0)) AS 'quantCB',
                    SUM(if(users.graduacao_id = 2, irsos_financeiros.valor_irso_cb * irsos.duracao, 0)) AS 'CB',
                    SUM(if(users.graduacao_id = 3, 1, 0)) AS 'quantSGT3',
                    SUM(if(users.graduacao_id = 3, irsos_financeiros.valor_irso_3sgt * irsos.duracao, 0)) AS 'SGT3',
                    SUM(if(users.graduacao_id = 4, 1, 0)) AS 'quantSGT2',
                    SUM(if(users.graduacao_id = 4, irsos_financeiros.valor_irso_2sgt * irsos.duracao, 0)) AS 'SGT2',
                    SUM(if(users.graduacao_id = 5, 1, 0)) AS 'quantSGT1',
                    SUM(if(users.graduacao_id = 5, irsos_financeiros.valor_irso_1sgt * irsos.duracao, 0)) AS 'SGT1',
                    SUM(if(users.graduacao_id = 6, 1, 0)) AS 'quantST',
                    SUM(if(users.graduacao_id = 6, irsos_financeiros.valor_irso_st * irsos.duracao, 0)) AS 'ST',
                    SUM(if(users.graduacao_id = 7, 1, 0)) AS 'quantTEN2',
                    SUM(if(users.graduacao_id = 7, irsos_financeiros.valor_irso_2ten * irsos.duracao, 0)) AS 'TEN2',
                    SUM(if(users.graduacao_id = 8, 1, 0)) AS 'quantTEN1',
                    SUM(if(users.graduacao_id = 8, irsos_financeiros.valor_irso_1ten * irsos.duracao, 0)) AS 'TEN1',
                    SUM(if(users.graduacao_id = 9, 1, 0)) AS 'quantCAP',
                    SUM(if(users.graduacao_id = 9, irsos_financeiros.valor_irso_cap * irsos.duracao, 0)) AS 'CAP',
                    SUM(if(users.graduacao_id = 10, 1, 0)) AS 'quantMAJ',
                    SUM(if(users.graduacao_id = 10, irsos_financeiros.valor_irso_maj * irsos.duracao, 0)) AS 'MAJ',
                    SUM(if(users.graduacao_id = 11, 1, 0)) AS 'quantTENCEL',
                    SUM(if(users.graduacao_id = 11, irsos_financeiros.valor_irso_tencel * irsos.duracao, 0)) AS 'TENCEL',
                    SUM(if(users.graduacao_id = 12, 1, 0)) AS 'quantCEL',
                    SUM(if(users.graduacao_id = 12, irsos_financeiros.valor_irso_cel * irsos.duracao, 0)) AS 'CEL'
                FROM irsos
